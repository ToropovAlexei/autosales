...
pub struct Settings {
    ...
    pub pricing_gateway_commission_mock_provider: BigDecimal,
    pub pricing_gateway_commission_platform_card: BigDecimal,
    pub pricing_gateway_commission_platform_sbp: BigDecimal,
...
pub struct UpdateSettings {
    ...
    pub pricing_gateway_commission_mock_provider: Option<BigDecimal>,
    pub pricing_gateway_commission_platform_card: Option<BigDecimal>,
    pub pricing_gateway_commission_platform_sbp: Option<BigDecimal>,
