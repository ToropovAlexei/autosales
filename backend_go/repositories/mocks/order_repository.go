...
func (m *MockOrderRepository) FindOrdersByBotUserID(botUserID uint) ([]models.Order, error) { args := m.Called(botUserID); if args.Get(0) == nil { return nil, args.Error(1) }; return args.Get(0).([]models.Order), args.Error(1) }
